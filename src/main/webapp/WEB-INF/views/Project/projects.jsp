...
<div class="section">
	...
	<table>
		<c:forEach items="${entities}" var="entity">
			<tr>
				<td>Project ${entity.id}</td>
				<td><a class="button" href="<c:url value="/projects/${entity.id}"/>">View</a></td>
				<td><a class="button" href="<c:url value="/projects/${entity.id}?edit=true"/>">Edit</a></td>
			</tr>
		</c:forEach>
	</table>
